...
import type { IProps as ITableProps } from './product.astro'

export const dataSapphireSubstrate: ITableProps['data'] = [
  {
...
export const dataPss: ITableProps['data'] = [
  {
    imgData: imgPss,
    rowData: [
      {
...
export const dataSic: ITableProps['data'] = [
  {
...
export const dataGanSubstrate: ITableProps['data'] = [
  {
...
export const dataAluminumNitrideSubstrate: ITableProps['data'] = [
  {
